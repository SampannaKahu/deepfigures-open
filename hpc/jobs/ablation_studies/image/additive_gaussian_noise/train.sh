...
EXPERIMENT_NAME=377269_0_to_4_arxiv_ablation_all_latex_transformations_enabled_additive_gaussian_noise_excluded
...
HYPES_PATH=$SOURCE_CODE/hpc/jobs/ablation_studies/image/additive_gaussian_noise/sample_hypes.json
MAX_ITER=20000
