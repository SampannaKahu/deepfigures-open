...
EXPERIMENT_NAME=377269_0_to_4_arxiv_ablation_all_latex_transformations_enabled_perspective_transform_excluded
...
HYPES_PATH=$SOURCE_CODE/hpc/jobs/ablation_studies/image/perspective_transform/sample_hypes.json
MAX_ITER=20000
