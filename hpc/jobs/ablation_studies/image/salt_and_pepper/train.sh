...
EXPERIMENT_NAME=377269_0_to_4_arxiv_ablation_all_latex_transformations_enabled_salt_and_pepper_excluded
...
HYPES_PATH=$SOURCE_CODE/hpc/jobs/ablation_studies/image/salt_and_pepper/sample_hypes.json
MAX_ITER=20000
