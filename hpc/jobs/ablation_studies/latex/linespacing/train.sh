...
EXPERIMENT_NAME=377267_arxiv_ablation_linespacing_transformation_enabled
...
if [ "$HOSTNAME" = "ir.cs.vt.edu" ]; then
  ...
  SCRATCH_DIR=/tmp
  ZIP_DIR=$DEEPFIGURES_RESULTS/pregenerated_training_data/377267
...
HYPES_PATH=$SOURCE_CODE/hpc/jobs/ablation_studies/latex/sample_hypes.json
MAX_ITER=20000
