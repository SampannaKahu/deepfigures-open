...
# from yolov3.util import count_parameters as count
from yolov3.pytorch_yolo_v3.util import convert2cpu as cpu
from yolov3.pytorch_yolo_v3.util import predict_transform
...
def get_test_input():
    img = cv2.imread("../../my_tests/resources/test_original.png")
