...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 4), // MatchResult()(wchar_t const *, wchar_t const *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 6), // wchar_t const *
/*  2 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  4 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // MatchResult
/*  5 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/*  6 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 16), // wchar_t
};

_CFFI_UNUSED_FN
static void _cffi_checkfld_typedef_MatchResult(MatchResult *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->start_pos) | 0);  /* check that 'MatchResult.start_pos' is an integer */
  (void)((p->end_pos) | 0);  /* check that 'MatchResult.end_pos' is an integer */
  (void)((p->cost) | 0);  /* check that 'MatchResult.cost' is an integer */
}
struct _cffi_align_typedef_MatchResult { char x; MatchResult y; };

static MatchResult _cffi_d_match(wchar_t const * x0, wchar_t const * x1)
{
  return match(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_match(PyObject *self, PyObject *args)
{
  wchar_t const * x0;
  wchar_t const * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "match", 2, 2, &arg0, &arg1))
    return NULL;
  ...
  (void)self; /* unused */
  return _cffi_from_c_struct((char *)&result, _cffi_type(4));
}
#else
static void _cffi_f_match(MatchResult *result, wchar_t const * x0, wchar_t const * x1)
{
  { *result = match(x0, x1); }
}
#endif
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "match", (void *)_cffi_f_match, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_match },
};

static const struct _cffi_field_s _cffi_fields[] = {
  { "start_pos", offsetof(MatchResult, start_pos),
                 sizeof(((MatchResult *)0)->start_pos),
                 _CFFI_OP(_CFFI_OP_NOOP, 5) },
  { "end_pos", offsetof(MatchResult, end_pos),
               sizeof(((MatchResult *)0)->end_pos),
               _CFFI_OP(_CFFI_OP_NOOP, 5) },
  { "cost", offsetof(MatchResult, cost),
            sizeof(((MatchResult *)0)->cost),
            _CFFI_OP(_CFFI_OP_NOOP, 5) },
};

static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "$MatchResult", 4, _CFFI_F_CHECK_FIELDS,
    sizeof(MatchResult), offsetof(struct _cffi_align_typedef_MatchResult, y), 0, 3 },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__stringmatch(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__stringmatch(void) { return NULL; }
#  else
     init_stringmatch(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__stringmatch(void)
{
  return _cffi_init("_stringmatch", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_stringmatch(void)
{
  _cffi_init("_stringmatch", 0x2601, &_cffi_type_context);
}
#endif
